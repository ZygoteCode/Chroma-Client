...
import net.minecraft.client.particle.chroma.module.render.NoWeather;
...
public abstract class World implements IBlockAccess
{
            ...
            for (int l1 = i1; l1 < j1; ++l1)
            {
                if (this.isBlockLoaded(blockpos$mutableblockpos.func_181079_c(k1, 64, l1)))
                {
                    for (int i2 = k - 1; i2 < l; ++i2)
                    {
                        ...
                        EventBlockCollide event = new EventBlockCollide(iblockstate1, blockpos$mutableblockpos, list);
                        ...
                        iblockstate1 = event.getiBlockState();
                        blockpos$mutableblockpos = event.getMutableBlockPos();
                        list = event.getList();
    ...
    public float getCelestialAngle(float partialTicks)
    {
    	...
    	{
    		return this.provider.calculateCelestialAngle(NoWeather.getChangedTime(), partialTicks);
    	}
