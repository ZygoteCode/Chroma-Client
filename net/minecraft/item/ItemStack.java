...
public final class ItemStack
{
    ...
    public void hitEntity(EntityLivingBase entityIn, EntityPlayer playerIn)
    {
        ...
        if (flag)
        {
        	EventAttack event = new EventAttack(EventState.PRE, playerIn, entityIn, 4, null, null);
        	...
        	EventAttack event1 = new EventAttack(EventState.POST, playerIn, entityIn, 4, null, null);
