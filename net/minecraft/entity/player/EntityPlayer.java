...
import net.minecraft.client.particle.chroma.event.events.EventDeath;
...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    {
        if (targetEntity.canAttackWithItem() || Minecraft.getMinecraft().getChroma().getModuleManager().getModuleByID(47).isToggled())
        {
            if (!targetEntity.hitByEntity(this) || Minecraft.getMinecraft().getChroma().getModuleManager().getModuleByID(47).isToggled())
            {
                ...
                if (f > 0.0F || f1 > 0.0F || Minecraft.getMinecraft().getChroma().getModuleManager().getModuleByID(47).isToggled())
                {
                    ...
                    EventAttack event = new EventAttack(EventState.PRE, this, targetEntity, 3, null, null);
                    EventManager.call(event);
                    ...
                    if (flag2 || Minecraft.getMinecraft().getChroma().getModuleManager().getModuleByID(47).isToggled())
                    {
                        EventAttack event1 = new EventAttack(EventState.POST, this, targetEntity, 3, null, null);
                        ...
                        if (i > 0)
                        {
                            ...
                            if (!Minecraft.getChroma().getModuleManager().getModuleByID(6).isToggled())
                            {
    ...
    {
    	if (!Minecraft.getMinecraft().getChroma().getModuleManager().getModuleByID(121).isToggled())
    	{
    ...
    {
    	EventPushWater event = new EventPushWater(this);
    	EventManager.call(event);
    	
        return !this.capabilities.isFlying && !event.isCancelled();
    }
