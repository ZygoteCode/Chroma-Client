...
import net.minecraft.client.particle.chroma.event.events.EventIsEntityInsideOpaqueBlock;
import net.minecraft.client.particle.chroma.event.events.EventSafeWalk;
import net.minecraft.client.particle.chroma.event.events.EventStep;
import net.minecraft.client.particle.chroma.event.events.EventUpdateWater;
...
public abstract class Entity implements ICommandSender
{
    ...
    {
    	EventEntityBoundingBox event = new EventEntityBoundingBox(width, height);
    ...
    public void setAngles(float yaw, float pitch)
    {
        ...
        if (!Minecraft.getMinecraft().getChroma().getModuleManager().getModuleByID(36).isToggled())
        {
    ...
    {
    	EventEntityMove event = new EventEntityMove(EventState.PRE, this, x, y, z);
    	EventManager.call(event);
        ...
        else
        {
            ...
            EventSafeWalk event2 = new EventSafeWalk(EventState.PRE, false, false);
            ...
            if (!event2.isProtectGround() && !event2.isProtectJump())
            {
            	flag = this.onGround && this.isSneaking() && this instanceof EntityPlayer;
            }
            else if (event2.isProtectGround() && event2.isProtectJump())
            {
            	flag = this instanceof EntityPlayer;
            }
            else if (event2.isProtectGround())
            {
            	flag = this.onGround && this instanceof EntityPlayer;
            }
            else if (event2.isProtectJump())
            {
            	flag = this instanceof EntityPlayer;
            }
            ...
            EventSafeWalk event3 = new EventSafeWalk(EventState.POST);
            ...
            EventStep event4 = new EventStep(EventState.PRE, this.stepHeight);
            EventManager.call(event4);
            ...
            if (event4.getStepHeight() > 0.0F && flag1 && (d3 != x || d5 != z))
            {
                double d11 = x;
                double d7 = y;
                double d8 = z;
            ...
            EventStep event5 = new EventStep(EventState.POST, event4.getStepHeight());
            EventManager.call(event5);
    	...
    	EventEntityMove event1 = new EventEntityMove(EventState.POST, this, x, y, z);
    ...
    public boolean handleWaterMovement()
    {
    	...
    	EventUpdateWater event = new EventUpdateWater(this, this.inWater);
    	EventManager.call(event);
    	
    	this.inWater = event.isInWater();
    ...
    public float getDistanceToEntity(Entity entityIn)
    {
        ...
        EventEntityReach event = new EventEntityReach(MathHelper.sqrt_float(f * f + f1 * f1 + f2 * f2), this, entityIn);
        EventManager.call(event);
    ...
    public double getDistanceSqToEntity(Entity entityIn)
    {
        ...
        EventEntityReach event = new EventEntityReach((float) (d0 * d0 + d1 * d1 + d2 * d2), this, entityIn);
        EventManager.call(event);
    ...
    {
    	EventIsEntityInsideOpaqueBlock event = new EventIsEntityInsideOpaqueBlock(this);
    	EventManager.call(event);
    ...
    {
    	EventHitbox event = new EventHitbox(0.1F);
    	EventManager.call(event);
