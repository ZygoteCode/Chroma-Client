...
public class FontUtil {
	...
	public static int getStringWidth(String text) {
		...
		return Hud.moduleDisplayer.getStringWidth(StringUtils.stripControlCodes(text));
	}
	...
	public static void drawString(String text, double x, double y, int color) {
		...
		Hud.moduleDisplayer.drawString(text, (int) x, (int) y, color);
	}

	public static void drawStringWithShadow(String text, double x, double y, int color) {
		//fontRenderer.drawStringWithShadow(text, (float) x, (float) y, color);
		Hud.moduleDisplayer.drawStringWithShadow(text, (float) x, (float) y, color);
	}
