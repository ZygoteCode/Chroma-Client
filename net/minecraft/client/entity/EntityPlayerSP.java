...
import net.minecraft.client.particle.chroma.event.events.*;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public static Timer savingTimer;
    ...
    {
        EventApplyMotion event = new EventApplyMotion(this.motionX, this.motionY, this.motionZ);
    ...
    public void onUpdate()
    {
        ...
        {
        	EventSuperUpdate superEvent = new EventSuperUpdate();
        	EventManager.call(superEvent);
        	...
        	EventUpdate event = new EventUpdate(EventState.POST);
        	EventManager.call(event);
        }
    }
    ...
    {
    	EventSprint event1 = new EventSprint(this.isSprinting());
        ...
        boolean flag = event1.isSprinting();
    	...
    	EventSneak event2 = new EventSneak(this.isSneaking());
        ...
        boolean flag1 = event2.isSneaking();
        ...
        {
        	EventUpdate event = new EventUpdate(EventState.PRE, this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround, this.motionX, this.motionY, this.motionZ);
        	EventManager.call(event);	
            ...
            flag2 = d0 * d0 + d1 * d1 + d2 * d2 > 9.0E-4D || this.positionUpdateTicks >= ((mc.getChroma().getModuleManager().getModuleByID(43).isToggled() && mc.getChroma().getSetManager().getSettingById(330).getValString().equals("Global")) ? 40 : 20);
            
            boolean flag3 = d3 != 0.0D || d4 != 0.0D;

            if (this.ridingEntity == null && !event.isCancelled())
            {
                if (flag2 && flag3)
                {
                ...
                {
                    if (!mc.getChroma().getModuleManager().getModuleByID(43).isToggled())
                    {
    ...
    public void sendChatMessage(String message)
    {
        ...
        if (Minecraft.getMinecraft().getChroma().onCommand(message))
        {
    ...
    public void swingItem()
    {
    	...
    	{
    		if (mc.thePlayer.getDistanceToEntity(mc.objectMouseOver.entityHit) <= 3.6D && !mc.objectMouseOver.entityHit.isDead)
    		{
    			EventAttack event1 = new EventAttack(EventState.PRE, this, mc.objectMouseOver.entityHit, 7, null, null);
    			EventManager.call(event1);
    ...
    {
    	EventPushOutOfBlocks event = new EventPushOutOfBlocks(x, y, z);
    	EventManager.call(event);
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding() && !(mc.getChroma().getModuleManager().getModuleByID(27).isToggled() && mc.getChroma().getSetManager().getSettingById(63).getValBoolean()))
        {
