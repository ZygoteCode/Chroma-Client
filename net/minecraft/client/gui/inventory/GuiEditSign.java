...
import net.minecraft.client.particle.chroma.module.other.AutoSign;
...
public class GuiEditSign extends GuiScreen
{
    ...
    public void initGui()
    {
        IChatComponent[] autoSignText = AutoSign.getSignText();
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            if (button.id == 0)
            {
            	AutoSign.setSignText(this.tileSign.signText);
