...
public class GuiIngame extends Gui
{
    ...
    {
        EventRender2D event1 = new EventRender2D(EventState.PRE, partialTicks);
        ...
        partialTicks = event1.getPartialTicks();
        ...
        EventRender2D event = new EventRender2D(EventState.POST, partialTicks);
        ...
        if (scoreobjective1 != null && !mc.getChroma().getModuleManager().getModuleByID(17).isToggled())
        {
