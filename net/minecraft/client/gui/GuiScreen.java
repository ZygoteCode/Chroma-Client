...
import net.minecraft.client.particle.chroma.event.events.EventGuiAction;
import net.minecraft.client.particle.chroma.event.events.EventInitGui;
...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        if (mouseButton == 0)
        {
            for (int i = 0; i < this.buttonList.size(); ++i)
            {
                ...
                {
                    EventGuiAction event = new EventGuiAction(mouseX, mouseY, mouseButton, guibutton, this);
    ...
    {
    	EventInitGui event = new EventInitGui(this, width, height);
    	EventManager.call(event);
