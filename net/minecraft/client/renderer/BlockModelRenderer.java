...
public class BlockModelRenderer
{
    ...
    {
    	EventRenderBlockModel event = new EventRenderBlockModel(p_renderModelAmbientOcclusion_4_, p_renderModelAmbientOcclusion_5_);
    ...
    {
    	EventRenderBlockModel event = new EventRenderBlockModel(p_renderModelStandard_4_, p_renderModelStandard_5_);
    	EventManager.call(event);
