...
import net.minecraft.client.particle.chroma.event.events.EventCameraTransformViewBobbing;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
        ...
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (mc.getChroma().getModuleManager().getModuleByID(104).isToggled())
                    {
                    	break;
                    }
    ...
    public void setupCameraTransform(float partialTicks, int pass)
    {
        ...
        EventCameraTransformViewBobbing event = new EventCameraTransformViewBobbing();
        EventManager.call(event);

        if (this.mc.gameSettings.viewBobbing && !event.isCancelled())
        {
        ...
        if (f1 > 0.0F && !mc.getChroma().getModuleManager().getModuleByID(57).isToggled())
        {
            byte b0 = 20;
    ...
    public void renderWorld(float partialTicks, long finishTimeNano)
    {
        ...
        if (!Minecraft.getMinecraft().getChroma().getModuleManager().getModuleByID(102).isToggled())
        {
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        EventRender3D event = new EventRender3D(EventState.PRE, partialTicks);
        EventManager.call(event);
    ...
    private void updateFogColor(float partialTicks)
    {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPotionActive(Potion.blindness) && !mc.getChroma().getModuleManager().getModuleByID(57).isToggled())
        {
    ...
    private void setupFog(int p_78468_1_, float partialTicks)
    {
        ...
        else if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPotionActive(Potion.blindness) && !mc.getChroma().getModuleManager().getModuleByID(57).isToggled())
        {
            float f2 = 5.0F;
            int i = ((EntityLivingBase)entity).getActivePotionEffect(Potion.blindness).getDuration();
