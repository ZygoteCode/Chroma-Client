...
import net.minecraft.client.particle.chroma.event.events.EventTick;
import net.minecraft.client.particle.chroma.ui.Hud;
import net.minecraft.client.particle.chroma.ui.TabGui;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public static Chroma getChroma()
    {
    	return chroma;
    }
     ...
     */
    private void startGame() throws LWJGLException, IOException, IllegalArgumentException, IllegalAccessException, ClassNotFoundException
    {
    ...
    public void clickMouse()
    {
        ...
        {
        	EventClickMouse event = new EventClickMouse(EventState.PRE, ClickType.LEFT);
        	EventManager.call(event);
            ...
            if (this.objectMouseOver == null)
            {
                ...
                {
                    this.leftClickCounter = getChroma().getModuleManager().getModuleByID(47).isToggled() ? 0 : 10;
                }
            }
            else
            {
        	...
        	EventClickMouse event1 = new EventClickMouse(EventState.POST, ClickType.LEFT);
     ...
     */ void rightClickMouse()
    {
        ...
        {
        	EventClickMouse event = new EventClickMouse(EventState.PRE, ClickType.RIGHT);
        	EventManager.call(event);
        	...
        	EventClickMouse event1 = new EventClickMouse(EventState.POST, ClickType.RIGHT);
        	EventManager.call(event1);
        }
    }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                    	EventKeyboard event1 = new EventKeyboard(k);
                    	EventManager.call(event1);
                    	...
                    	getChroma().getModuleManager().onModuleKey(k);
                    	TabGui.onKey(k);
    ...
    public void middleClickMouse()
    {
        if (this.objectMouseOver != null)
        {
        	EventClickMouse event = new EventClickMouse(EventState.PRE, ClickType.MIDDLE);
        	EventManager.call(event);
        	...
        	EventClickMouse event1 = new EventClickMouse(EventState.POST, ClickType.MIDDLE);
        	EventManager.call(event1);
        }
    }
