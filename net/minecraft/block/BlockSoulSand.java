...
public class BlockSoulSand extends Block
{
    ...
    {
    	if (!(Minecraft.getMinecraft().getChroma().getModuleManager().getModuleByID(27).isToggled() && Minecraft.getMinecraft().getChroma().getSetManager().getSettingById(64).getValBoolean()))
    	{
