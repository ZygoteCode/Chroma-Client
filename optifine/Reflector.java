...
public class Reflector
{
    ...
    public static ReflectorMethod ForgeHooksClient_applyTransform = new ReflectorMethod(ForgeHooksClient, "applyTransform", new Class[] {net.minecraft.util.Matrix4f.class, Optional.class});
